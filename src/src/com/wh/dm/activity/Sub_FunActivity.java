...
public class Sub_FunActivity extends Activity {
    ...
    class GetMagazine extends AsyncTask<Void, Void, ArrayList<TwoMagazine>> {
        ...
        protected void onPreExecute() {
            ...
            if (isFirstLauncher) {
                savedMagazine = MagazineUtil.toTwoMagazine(databaseImpl.getFunMagazine());
        ...
        protected void onPostExecute(ArrayList<TwoMagazine> result) {
            ...
            if (result != null && result.size() > 0) {
                if (isFirstLoad) {
                    databaseImpl.deleteFunMagazine();
                    isFirstLoad = false;
                }
                if (FLAG_PAGE_UP) {
                ...
                addStatus(adapter);
                databaseImpl.addFunMagazine(MagazineUtil.toOneMagazine(result));
