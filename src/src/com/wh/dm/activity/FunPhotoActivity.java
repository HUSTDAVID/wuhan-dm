...
public class FunPhotoActivity extends Activity {
    ...
    private void initViews() {
        ...
        SharedPreferences preference = PreferenceManager
                .getDefaultSharedPreferences(FunPhotoActivity.this);
        id = preference.getInt(Preferences.PHOTO_FOUR_ID, 220);
    ...
    private class GetPhotosTask extends AsyncTask<Void, Void, ArrayList<TwoPhotos>> {
        ...
        protected ArrayList<TwoPhotos> doInBackground(Void... params) {
            ...
            try {
                photos = wh_dmApi.getFunPhotos(curPage, id);
                return photos;
            } catch (Exception e) {
                reason = e;
                e.printStackTrace();
            ...
            if (result != null && result.size() > 0) {
                ...
                if (!FLAG_PAGE_UP) {
                    ...
                    if (wh_dmApp.isConnected()) {
                        NotificationUtil.showShortToast(reason.toString(), FunPhotoActivity.this);
                    } else {
