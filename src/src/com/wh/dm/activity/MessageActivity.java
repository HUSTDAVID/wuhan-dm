    ...
    private final Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == MSG_GET_FAV) {
                ...
                getNewsFavTask.execute(countsPerPage, curPage);// param1:counts per page;
                                                           // param2:current page
            }
    ...
    private void init() {
        ...
        btnFoolter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	if(!WH_DMApp.isConnected){
            		NotificationUtil.showShortToast(getString(R.string.check_network),MessageActivity.this);
                    return;
            	}
                if(!WH_DMApp.isLogin){
                	NotificationUtil.showShortToast(getString(R.string.please_login),MessageActivity.this);
                    return;
                }
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (newsCollectAdapter.getCheckedID() == null || newsCollectAdapter.getCheckedID().size() == 0) {
                    return;
                }
                if (!WH_DMApp.isConnected) {
                    NotificationUtil.showShortToast(getString(R.string.check_network),MessageActivity.this);
    ...
    private class GetNewsFavTask extends AsyncTask<Integer, Void, ArrayList<FavoriteNews>> {
        ...
        protected void onPostExecute(ArrayList<FavoriteNews> result) {
            ...
            if (result == null || result.size() == 0) { 
            	 if (FLAG_PAGE_UP){
                     NotificationUtil.showShortToast(getString(R.string.no_more_message),MessageActivity.this);
                     FLAG_PAGE_UP = false;
                 }
            	 else{
