...
public class DM_MZine2Activity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dm_mzine2);
    ...
    private void initViews() {
        ...
        linearLayouItem1 = (LinearLayout) findViewById(R.id.layout1_magazine_2);
        linearLayouItem2 = (LinearLayout) findViewById(R.id.layout2_magazine_2);
        linearLayouItem3 = (LinearLayout) findViewById(R.id.layout3_magazine_2);
        linearLayouItem4 = (LinearLayout) findViewById(R.id.layout4_magazine_2);
        linearLayouItem5 = (LinearLayout) findViewById(R.id.layout5_magazine_2);

        txtTile1 = (TextView) findViewById(R.id.txt_magazine_2_title1);
        txtTile2 = (TextView) findViewById(R.id.txt_magazine_2_title2);
        txtTile3 = (TextView) findViewById(R.id.txt_magazine_2_title3);
        txtTile4 = (TextView) findViewById(R.id.txt_magazine_2_title4);
        txtTile5 = (TextView) findViewById(R.id.txt_magazine_2_title5);
