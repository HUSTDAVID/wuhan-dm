...
public class MainActivity extends Activity {
	...
	public void initData() {
		...
		for (int i = 0; i < Configure.countPages; i++) {
			...
			for (int j = PAGE_SIZE * i; j < (PAGE_SIZE * (i + 1) > data.size() ? data
					.size() : PAGE_SIZE * (i + 1)); j++)
	...
	public LinearLayout addGridView(final int i) {
		...
		gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
				...
				case 0:
					Intent intent_tab1 = new Intent(MainActivity.this,
							DM_Tab_1Activity.class);
		...
		gridView.setOnItemChangeListener(new DragGrid.G_ItemChangeListener() {
			...
			public void change(int from, int to, int count) {
				...
				Cover toString = lists.get(Configure.curentPage - count).get(
						from);
	...
	public void setCurPage(final int page) {
		...
		a.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				txt_page.startAnimation(AnimationUtils.loadAnimation(
						MainActivity.this, R.anim.scale_out));
			}
